...
#open OUTPUT, ">FEELnc_all_trans_nc.txt";
print "lncRNA_gene\tRNA_transcript_number_in_this_gene\tlncRNA_transcript_number_in_this_gene\tlncRNA_transcript (coding potential)\n";
foreach my $gene (@genes) {
        ...
        foreach my $tra (@tran) {
                my $cod_pot;
                $coding{$tra}?($cod_pot=$coding{$tra}):($cod_pot=100);
